      ...
      <main className="md:ml-64 flex-1 p-4 sm:p-6 md:p-8 lg:p-12 pt-20 md:pt-8 lg:pt-12">
        <div className="max-w-5xl">
          ...
          <div className="mb-6 md:mb-10">
            <h1 className="text-2xl sm:text-3xl font-medium text-white mb-2 tracking-tight">Brand Match</h1>
            <p className="text-sm md:text-base text-white/40">Discover creators whose content style aligns with your brand</p>
          </div>

          {/* Search */}
          <form onSubmit={handleMatch} className="mb-6 md:mb-8">
            <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-end">
              ...
              <button
                ...
                className="w-full sm:w-auto px-4 py-3 bg-white/[0.03] border border-white/[0.08] rounded-xl text-white/60 hover:text-white hover:bg-white/[0.05] hover:border-white/[0.12] transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="w-full sm:flex-1 px-6 py-3 bg-white text-black font-medium rounded-xl hover:bg-white/90 disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center gap-2 min-w-0 sm:min-w-[120px] justify-center"
              >
                {loading ? (
                  <>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                      ...
                      <div className="flex items-center gap-3 sm:gap-4 w-full sm:flex-1">
                        ...
                        {match.profile.profile_image_url ? (
                          ...
                          <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-white/5 flex items-center justify-center shrink-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5 sm:gap-2 mb-0.5">
                            <span className="font-medium text-white text-sm sm:text-base truncate">{match.profile.name}</span>
                            {match.profile.verified && (
                              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-400 shrink-0" fill="currentColor" viewBox="0 0 24 24">
                          ...
                          <div className="flex items-center gap-2">
                            <a
                              ...
                              rel="noopener noreferrer"
                              onClick={(e) => e.stopPropagation()}
                              className="text-xs sm:text-sm text-white/30 hover:text-white/50 transition-colors truncate"
                            >
                              @{match.profile.username}
                            </a>
                            <span className="text-xs text-white/30 shrink-0">· {formatFollowers(match.profile.follower_count)}</span>
                          </div>
                        </div>

                        {/* Score - visible on mobile */}
                        <div className={`sm:hidden px-2.5 py-1.5 rounded-lg bg-gradient-to-r border flex items-center shrink-0 ${getScoreStyle(match.score)}`}>
                          <span className="text-xs font-medium">{((match.score || 0) * 100).toFixed(0)}%</span>
                        </div>
                      </div>

                      {/* Bio - full width on mobile */}
                      <p className="text-sm text-white/40 line-clamp-2 sm:hidden w-full">{match.profile.description || 'No bio'}</p>
                      ...
                      <div className="hidden sm:flex items-center gap-3 lg:gap-4">
                        ...
                        {/* Score */}
                        <div className={`px-3 py-2 rounded-lg bg-gradient-to-r border flex items-center h-[38px] shrink-0 ${getScoreStyle(match.score)}`}>
                        ...
                        <button
                          ...
                          className="px-3 py-2 rounded-lg bg-gradient-to-r from-cyan-500/20 to-cyan-500/5 border border-cyan-500/20 text-cyan-400 text-xs font-medium hover:from-cyan-500/30 hover:to-cyan-500/10 transition-all disabled:opacity-50 flex items-center gap-1.5 h-[38px] shrink-0"
                        >
                          ...
                          <span className="hidden xl:inline">{loadingPrediction === match.profile.username ? 'Thinking...' : 'Predict'}</span>
                        </button>
                        ...
                        <button
                          ...
                          className="px-3 py-2 rounded-lg bg-gradient-to-r from-purple-500/20 to-purple-500/5 border border-purple-500/20 text-purple-400 text-xs font-medium hover:from-purple-500/30 hover:to-purple-500/10 transition-all disabled:opacity-50 flex items-center gap-1.5 h-[38px] shrink-0"
                        >
                          ...
                          <span className="hidden xl:inline">{loadingExplanation === match.profile.username ? 'Thinking...' : 'Why?'}</span>
                        </button>

                        {/* Arrow */}
                        {searcherType === 'brand' && (
                          <svg className="w-5 h-5 text-white/20 group-hover:text-white/40 group-hover:translate-x-1 transition-all shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5l7 7-7 7" />
                          </svg>
                        )}
                      </div>
                      ...
                      <div className="flex sm:hidden gap-2 w-full mt-2">
                        <button
                          onClick={(e) => handlePredictPerformance(e, match)}
                          disabled={loadingPrediction === match.profile.username}
                          className="flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-cyan-500/20 to-cyan-500/5 border border-cyan-500/20 text-cyan-400 text-xs font-medium hover:from-cyan-500/30 hover:to-cyan-500/10 transition-all disabled:opacity-50 flex items-center justify-center gap-1.5"
                        >
                          {loadingPrediction === match.profile.username ? (
                            <GrokLoader size="small" />
                          ) : (
                        ...
                        <button
                          onClick={(e) => handleExplainMatch(e, match)}
                          disabled={loadingExplanation === match.profile.username}
                          className="flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-purple-500/20 to-purple-500/5 border border-purple-500/20 text-purple-400 text-xs font-medium hover:from-purple-500/30 hover:to-purple-500/10 transition-all disabled:opacity-50 flex items-center justify-center gap-1.5"
                        >
                          {loadingExplanation === match.profile.username ? (
                            <GrokLoader size="small" />
                          ) : (
          ...
          <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl max-w-lg w-full overflow-hidden">
            ...
            {!loadingOutreach && outreachMessage && (
              <div className="p-4 border-t border-white/[0.06] flex justify-end gap-3">
                ...
                <a
                  href={`https://x.com/${outreachCreator?.username}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => {
                    navigator.clipboard.writeText(outreachMessage);
  ...
  return (
    <Suspense fallback={
      <div className="flex min-h-screen bg-[#050505]">
        ...
        <main className="md:ml-64 flex-1 p-4 sm:p-6 md:p-8 lg:p-12 pt-20 md:pt-8 lg:pt-12 flex items-center justify-center">
          <div className="text-center">
